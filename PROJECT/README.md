...
| 23     | Start creating the style of the Main Screen | Use CSS to create the design and visuals of the Main screen. Create interactive bookshel that divides posts for each book | 20 min | May 3 | C
